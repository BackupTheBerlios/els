...
sub OuterTableBegin ($)
{
    ...
    #html "<!-- outer table -->";
    html "<P>";
    html "<TABLE $width BORDER=1 CELLPADDING=2 CELLSPACING=0 _COLS=1 BGCOLOR=\"#c0c0c0\">";
}
...
sub TableBegin ($$)
{
    ...
    #html "<!-- border table -->";
    html "<TABLE WIDTH=\"90%\" BORDER=1 CELLPADDING=0 CELLSPACING=0 _COLS=1>";
    html "<TR><TD>";
    #html "<!-- inner table -->";
    html "<CENTER>";
...
sub ProcessMenuFile ($)
{
    ...
    if ($EmitHTML) {
	html '<P>';
	html '<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="10" WIDTH="100%" BORDERCOLOR="#FFFFCC" BGCOLOR="#FFFFCC">';
	html '<TR><TD>';
